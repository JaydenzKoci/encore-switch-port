...
execute_process(
  COMMAND "C:/devkitPro/msys2/usr/bin/git.exe" --git-dir=.git show-ref "5.0"
  WORKING_DIRECTORY "C:/Users/jayde/build-switch/EncoreSwitchPort/cmake-build-debug/_deps/raylib-src"
...
if(git_update_strategy STREQUAL "CHECKOUT")
  ...
  if(error_code)
    ...
    if(NOT git_update_strategy STREQUAL "REBASE_CHECKOUT")
      ...
      message(FATAL_ERROR "\nFailed to rebase in: 'C:/Users/jayde/build-switch/EncoreSwitchPort/cmake-build-debug/_deps/raylib-src'."
...
if(need_stash)
  ...
  if(error_code)
    ...
    if(error_code)
      ...
      message(FATAL_ERROR "\nFailed to unstash changes in: 'C:/Users/jayde/build-switch/EncoreSwitchPort/cmake-build-debug/_deps/raylib-src'."
                          "\nYou will have to resolve the conflicts manually")
    endif()
  endif()
endif()
